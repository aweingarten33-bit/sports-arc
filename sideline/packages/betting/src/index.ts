...
export class MockOddsProvider implements OddsProvider { async snapshots(marketId:string):Promise<OddsSnapshot[]> {return [{id:'o1',marketId,line:26.5,odds:-115,capturedAt:'2026-09-23T12:00:00Z',source:'MOCK'},{id:'o2',marketId,line:27.5,odds:-110,capturedAt:'2026-09-24T12:00:00Z',source:'MOCK'}];} }
